...
const ASSEMBLY_MAGIC_CONSTANT_REJECTION: &str = "assembly magic-constant lowering rejects executable magic constants __LINE__, __FILE__, __DIR__, __FUNCTION__, and __METHOD__ until native source mapping, path canonicalization, and function/method-context lowering exist; phpc run handles current magic constant behavior";
