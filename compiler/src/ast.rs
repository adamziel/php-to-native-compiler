...
pub enum AssignTarget {
    ...
    NonDirectObjectPropertyArrayAppend {
        holder: Expr,
        property: String,
        indices: Vec<Expr>,
        suffix_indices: Vec<Expr>,
    ...
    NonDirectDynamicObjectPropertyArrayAppend {
        holder: Expr,
        property: Expr,
        indices: Vec<Expr>,
        suffix_indices: Vec<Expr>,
...
pub enum ReferenceSource {
    ...
    NonDirectDynamicObjectPropertyNestedArrayIndex {
        holder: Expr,
        property: Expr,
        indices: Vec<Expr>,
        span: Span,
...
#[derive(Debug, Clone, PartialEq)]
pub struct TraitMethodPrecedenceDecl {
    pub trait_name: String,
    pub method_name: String,
    pub loser_trait_name: String,
    pub span: Span,
}
