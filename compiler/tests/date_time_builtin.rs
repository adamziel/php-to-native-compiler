...
#[test]
fn datetimezone_and_datetime_serialize_roundtrip_bounded_rows() {
    let execution = run_source(
        r#"<?php
date_default_timezone_set("UTC");
...
"#,
    ...
    assert_eq!(
        execution.stdout,
        concat!(
            "O:12:\"DateTimeZone\":2:{s:13:\"timezone_type\";i:3;s:8:\"timezone\";s:11:\"Europe/Oslo\";}\n",
            "Europe/Oslo|a:2:{s:13:\"timezone_type\";i:3;s:8:\"timezone\";s:11:\"Europe/Oslo\";}\n",
            "O:12:\"DateTimeZone\":2:{s:13:\"timezone_type\";i:1;s:8:\"timezone\";s:6:\"+04:00\";}\n",
            "O:8:\"DateTime\":3:{s:4:\"date\";s:26:\"2005-07-14 22:30:41.000000\";s:13:\"timezone_type\";i:2;s:8:\"timezone\";s:3:\"GMT\";}\n",
            "1121380241|GMT|2005-07-14 22:30:41\n",
            "1121380241|GMT|2005-07-14 22:30:41\n",
            "tz-method|dt-method\n",
        )
    );
