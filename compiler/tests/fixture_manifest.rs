...
fn cli_list_fixtures_prints_deterministic_manifest_without_running_fixtures() {
    ...
    assert_eq!(
        ...
        concat!(
            ...
            "alpha.php expectations=stdout cli-exercise=yes missing-expectation-sidecars=stderr,exit php-comparison=eligible bytes source=20 stdout=6 stderr=- exit=- cli=19 phpc-only=- sha256 source=736f8cf99e32d995b4b811014e31aa90592b9f833bd316904db901f7e6ed8491 stdout=b6a98d9ce9a2d9149288fa3df42d377c3e42737afdcdaf714e33c0a100b51060 stderr=- exit=- cli=6610ff430f77cce31f8c81c88e4f3fc69e28a63cf51d0b8d1046300c73fbc815 phpc-only=-\n",
            "nested/beta.php expectations=stderr,exit cli-exercise=no missing-expectation-sidecars=stdout,cli php-comparison=phpc-only phpc-only-reason=project diagnostic has no system PHP equivalent bytes source=19 stdout=- stderr=12 exit=2 cli=- phpc-only=48 sha256 source=f7ca816521704652b33d26ad5f905019440c2c472d0b73ed90ec535a5d0f1535 stdout=- stderr=72df5c482da8d3b6e1ecc9442ec423146fada46cec1ad169cf326c1b6a59c72b exit=10159baf262b43a92d95db59dae1f72c645127301661e0a3ce4e38b295a97c58 cli=- phpc-only=fa26c305add1684932b4d26c03ec6015a72a3b6ef748792412b2a97c8029f8cf\n",
            "zeta.php expectations=none cli-exercise=no missing-expectation-sidecars=stdout,stderr,exit,cli php-comparison=eligible bytes source=25 stdout=- stderr=- exit=- cli=- phpc-only=- sha256 source=465085f544a0549b3ec91bec6a86325edffea5eb0d0a08562840a652a302b297 stdout=- stderr=- exit=- cli=- phpc-only=-\n",
        )
    );
}
...
fn cli_list_fixtures_reports_orphan_sidecars_deterministically() {
    ...
    assert_eq!(
        ...
        concat!(
            ...
            "live.php expectations=stdout cli-exercise=no missing-expectation-sidecars=stderr,exit,cli php-comparison=phpc-only phpc-only-reason= bytes source=19 stdout=5 stderr=- exit=- cli=- phpc-only=0 sha256 source=682ffe3a3fb058f93115cb72110f778b63ac40029040da258b9e95284c2b5e91 stdout=7a0c3ac0d35f7d3b985ef0e678fab3f36ef28c158cc62d095183e9589d084ae5 stderr=- exit=- cli=- phpc-only=e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855\n",
...
fn cli_list_fixtures_reports_compatibility_target_byte_counts() {
    ...
    assert_eq!(
        ...
        concat!(
            ...
            "compat/php/cross_feature.php expectations=stdout cli-exercise=yes missing-expectation-sidecars=stderr,exit php-comparison=eligible bytes source=17 stdout=3 stderr=- exit=- cli=38 phpc-only=- sha256 source=db28e0750bdb4bf54f1458e8b5d9359db9963be65493b9cce66e0e16d57e67fd stdout=dc51b8c96c2d745df3bd5590d990230a482fd247123599548e0632fdbf97fc22 stderr=- exit=- cli=26072ce2b552de26d91fbe0f19284acebb49bbeb2aa0ab7ee5a89aa062520dc3 phpc-only=-\n",
            "compat/php/skipped.php expectations=none cli-exercise=no missing-expectation-sidecars=stdout,stderr,exit,cli php-comparison=phpc-only phpc-only-reason=compat target uses a project-only diagnostic bytes source=19 stdout=- stderr=- exit=- cli=- phpc-only=45 sha256 source=c5b495fe803004850d43c138f28a9c97c3c8df5d31216d8f466675cfa64b11c9 stdout=- stderr=- exit=- cli=- phpc-only=fd374f05838ba6a0f157d2754ef88c613394d70d654142bb20538d0988da4861\n",
