...
fn cli_list_fixtures_reports_orphan_sidecars_deterministically() {
    ...
    assert_eq!(
        ...
        concat!(
            ...
            "live.php expectations=stdout cli-exercise=no missing-expectation-sidecars=stderr,exit,cli php-comparison=phpc-only phpc-only-reason= bytes source=19 stdout=5 stderr=- exit=- cli=- phpc-only=0 sha256 stdout=7a0c3ac0d35f7d3b985ef0e678fab3f36ef28c158cc62d095183e9589d084ae5 stderr=- exit=- cli=- phpc-only=e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855\n",
