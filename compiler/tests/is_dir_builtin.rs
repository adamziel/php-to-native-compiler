...
fn fixture_source_file() -> String {
    ...
    manifest_dir
        ...
        .join("tests/fixtures/milestone786/is_dir.php")
        .display()
        .to_string()
}
...
#[test]
fn is_dir_checks_current_local_filesystem_subset() {
...
"#,
    ...
    assert_eq!(execution.stdout, "dir|file|missing");
    assert_eq!(execution.exit_code, 0);
}

#[test]
fn is_dir_is_available_through_string_valued_calls() {
    let execution = run_source_with_source_file(
        r#"<?php
$call = "is_dir";
...
#[test]
fn emit_ir_rejects_is_dir_until_native_filesystem_lowering_exists() {
    let error = emit_ir_source(
        r#"<?php
echo is_dir("wp-content/themes") ? "yes" : "no";
"#,
    )
    .unwrap_err();
...
#[test]
fn emit_ir_includes_is_dir_in_native_callable_lookup_table() {
    let ir = emit_ir_source(
        r#"<?php
echo function_exists("is_dir") ? "1" : "0";
echo is_callable("is_dir") ? "1" : "0";
"#,
    )
    .unwrap();
