...
fn array_value_intersection_builtin_cli_snapshots_match_committed_outputs() {
    ...
    let fixture_dir = workspace_root.join("tests/fixtures/milestone43");
    ...
    for fixture in fixtures {
        let file_name = fixture
            ...
            .expect("array-value-intersection fixture file name is valid UTF-8");
        let fixture_arg = format!("tests/fixtures/milestone43/{file_name}");
