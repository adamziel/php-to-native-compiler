...
function &milestone2219_pick_ref(&$value) {
    return $value["ref"]["value"];
}

class Milestone2219_ArgsHolder {
    public $args = array();
}

class Milestone2219_Box {
    public $store = array();
    public $holder;
    public $calls = 0;
...
$box = new Milestone2219_Box();
$box->holder = new Milestone2219_ArgsHolder();
$box->store = array(
    "slot" => array(
