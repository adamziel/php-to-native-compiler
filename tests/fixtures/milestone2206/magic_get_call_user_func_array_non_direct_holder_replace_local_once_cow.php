...
function &milestone2206_pick_ref(&$value) {
    return $value["ref"]["value"];
}

class Milestone2206_ArgsHolder {
    public $args = array();
}

class Milestone2206_Box {
    public $store = array();
    public $holder;
    public $calls = 0;
...
$box = new Milestone2206_Box();
$box->holder = new Milestone2206_ArgsHolder();
$box->store = array(
    "slot" => array(
