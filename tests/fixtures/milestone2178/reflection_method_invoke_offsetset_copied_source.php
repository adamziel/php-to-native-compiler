...
class Milestone2178_TargetBag implements ArrayAccess {
    public $store = array();
    ...
    public function offsetSet($offset, $value) {
        $method = new ReflectionMethod($this, "save");
        $method->invoke($this, $offset, $value);
    }
...
$target = new Milestone2178_TargetBag();
