...
function &milestone2211_pick_ref(&$value) {
    return $value["ref"]["value"];
}

class Milestone2211_ArgsHolder {
    public $args = array();
}

class Milestone2211_Box {
    public $store = array();
    public $holder;
    public $calls = 0;
...
$box = new Milestone2211_Box();
$box->holder = new Milestone2211_ArgsHolder();
$box->store = array(
    "slot" => array(
