...
class Milestone2228_ArgsHolder {
    public $args = array();
}

class Milestone2228_Box implements ArrayAccess {
    public $store = array();
    public $holder;
    public $calls = 0;
    ...
    public function callback($copy) {
        $this->calls = $this->calls + 1;
        unset($this->holder->args);
        $this->holder->args = array($copy);
        return array($this, "pickRef");
    }
...
$box = new Milestone2228_Box();
$box->holder = new Milestone2228_ArgsHolder();
$box->store = array(
    "slot" => array(
