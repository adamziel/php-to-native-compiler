<?php
function milestone2027_touch_bucket(&$value) {
    $value["ref"]["value"] = "inside";
    $value["plain"]["value"] = "plain-inside";
    $value["ref"] = array("value" => "replaced");
}

class Milestone2027_Holder {
    public $bucket = array();
}

class Milestone2027_Bag implements ArrayAccess {
    public $store = array();
    ...
    public function offsetGet($offset) {
        $holder = new Milestone2027_Holder();
        $holder->bucket = $this->store[$offset];
        milestone2027_touch_bucket($holder->bucket);
