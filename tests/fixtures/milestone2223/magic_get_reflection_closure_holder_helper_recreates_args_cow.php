...
function &milestone2223_pick_ref(&$value) {
    return $value["ref"]["value"];
}

class Milestone2223_ArgsHolder {
    public $args = array();
}

class Milestone2223_Box {
    public $store = array();
    public $holder;
    public $calls = 0;
...
$box = new Milestone2223_Box();
$box->holder = new Milestone2223_ArgsHolder();
$box->store = array(
    "slot" => array(
