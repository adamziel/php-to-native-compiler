...
class Milestone1689_DynamicMagicPlainArrayAppendBox {
...
$box = new Milestone1689_DynamicMagicPlainArrayAppendBox();
$property = "missing";
$box->{$property}[] = [
    "id" => $node,
...
foreach ($bucket as $id => &$callback) {
    if ($id === "id") {
        $callback["function"] = "via-dynamic-magic-array-append";
        $callback["label"] = "via-dynamic-magic-array-label";
