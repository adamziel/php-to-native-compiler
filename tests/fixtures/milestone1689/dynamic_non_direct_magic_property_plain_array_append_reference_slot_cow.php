...
class Milestone1689_DynamicNonDirectMagicPlainArrayAppendBox {
...
$property = "missing";
$holders = ["box" => new Milestone1689_DynamicNonDirectMagicPlainArrayAppendBox()];
$holders["box"]->{$property}[] = [
    "id" => $node,
...
foreach ($bucket as $id => &$callback) {
    if ($id === "id") {
        $callback["function"] = "via-dynamic-non-direct-magic-array-append";
        $callback["label"] = "via-dynamic-non-direct-magic-array-label";
