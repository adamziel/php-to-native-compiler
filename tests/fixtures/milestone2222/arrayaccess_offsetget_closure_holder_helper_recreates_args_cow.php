...
function &milestone2222_pick_ref(&$value) {
    return $value["ref"]["value"];
}

class Milestone2222_ArgsHolder {
    public $args = array();
}

class Milestone2222_Box implements ArrayAccess {
    public $store = array();
    public $holder;
    public $calls = 0;
...
$box = new Milestone2222_Box();
$box->holder = new Milestone2222_ArgsHolder();
$box->store = array(
    "slot" => array(
