<?php
class Milestone1838_Hook implements ArrayAccess {
...
function milestone1838_mutate($bucket, $label) {
...
$callback = "seed";
$hook = new Milestone1838_Hook();
$hook->add(10, $callback);
$bucket = $hook[10];
milestone1838_mutate($bucket, "direct");

echo $callback, "|", $hook->callbacks[10]["id"]["function"], "|", $hook->callbacks[10]["id"]["accepted_args"], "|", $hook->callbacks[10]["plain"]["function"], "|", $hook->hits[0];
