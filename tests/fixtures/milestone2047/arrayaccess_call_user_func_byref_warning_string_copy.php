...
function milestone2047_touch_bucket(&$value) {
    $value["ref"]["value"] = "inside";
    $value["plain"]["value"] = "inside-plain";
    return $value;
}

class Milestone2047_Bag implements ArrayAccess {
    public $store = array();
    ...
    public function offsetGet($offset) {
        ...
        return call_user_func("milestone2047_touch_bucket", $bucket);
    }
