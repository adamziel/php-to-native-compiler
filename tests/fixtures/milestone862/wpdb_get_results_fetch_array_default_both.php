...
echo count($rows), "\n";
echo $wpdb->num_rows, "\n";
echo $rows[0][0], "|", $rows[0]["ID"], "\n";
echo $rows[0][1], "|", $rows[0]["post_title"], "\n";
echo $wpdb->last_result[0][0], "|", $wpdb->last_result[0]["ID"], "\n";
echo $wpdb->last_result[0][1], "|", $wpdb->last_result[0]["post_title"];
