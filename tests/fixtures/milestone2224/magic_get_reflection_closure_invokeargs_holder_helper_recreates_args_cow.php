...
function &milestone2224_pick_ref(&$value) {
    return $value["ref"]["value"];
}

class Milestone2224_ArgsHolder {
    public $args = array();
}

class Milestone2224_Box {
    public $store = array();
    public $holder;
    public $calls = 0;
...
$box = new Milestone2224_Box();
$box->holder = new Milestone2224_ArgsHolder();
$box->store = array(
    "slot" => array(
