...
function &milestone2225_pick_ref(&$value) {
    return $value["ref"]["value"];
}

class Milestone2225_ArgsHolder {
    public $args = array();
}

class Milestone2225_Box implements ArrayAccess {
    public $store = array();
    public $holder;
    public $calls = 0;
    ...
    public function offsetGet($name) {
        ...
        $alias =& call_user_func_array(
            "milestone2225_pick_ref",
            $reflection->invoke($bucket)->args
        );
        $alias = "inside";
        return $bucket;
    }
...
$box = new Milestone2225_Box();
$box->holder = new Milestone2225_ArgsHolder();
$box->store = array(
    "slot" => array(
