...
function &milestone2217_pick_ref(&$value) {
    return $value["ref"]["value"];
}

class Milestone2217_ArgsHolder {
    public $args = array();
}

class Milestone2217_Box implements ArrayAccess {
    public $store = array();
    public $holder;
    public $calls = 0;
...
$box = new Milestone2217_Box();
$box->holder = new Milestone2217_ArgsHolder();
$box->store = array(
    "slot" => array(
