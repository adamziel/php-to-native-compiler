...
class Milestone1691_DynamicMagicPlainArrayDeepNestedAppendBox {
...
$property = "missing";
$box = new Milestone1691_DynamicMagicPlainArrayDeepNestedAppendBox();
...
foreach ($bucket as $id => &$callback) {
    if ($id === "id") {
        $callback["function"] = "via-dynamic-magic-deep-nested-append";
        $callback["label"] = "via-dynamic-magic-deep-nested-label";
