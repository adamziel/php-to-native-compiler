...
class Milestone1691_NonDirectMagicPlainArrayDeepNestedAppendBox {
...
$holders = ["box" => new Milestone1691_NonDirectMagicPlainArrayDeepNestedAppendBox()];
$holders["box"]->missing["outer"]["inner"][] = [
    "id" => $node,
...
foreach ($bucket as $id => &$callback) {
    if ($id === "id") {
        $callback["function"] = "via-non-direct-magic-deep-nested-append";
        $callback["label"] = "via-non-direct-magic-deep-nested-label";
