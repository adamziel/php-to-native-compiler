...
class Milestone1691_MagicPlainArrayDeepNestedAppendBox {
...
$box = new Milestone1691_MagicPlainArrayDeepNestedAppendBox();
...
foreach ($bucket as $id => &$callback) {
    if ($id === "id") {
        $callback["function"] = "via-magic-deep-nested-append";
        $callback["label"] = "via-magic-deep-nested-label";
