...
class Milestone1690_DynamicNonDirectMagicPlainArrayNestedAppendBox {
...
$property = "missing";
$holders = ["box" => new Milestone1690_DynamicNonDirectMagicPlainArrayNestedAppendBox()];
...
foreach ($bucket as $id => &$callback) {
    if ($id === "id") {
        $callback["function"] = "via-dynamic-non-direct-magic-nested-append";
        $callback["label"] = "via-dynamic-non-direct-magic-nested-label";
