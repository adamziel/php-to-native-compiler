...
- Simple `use Name\Parts as Alias;`, `use function Name\Parts as alias;`, and
  ...
  `use Name\Parts\{ClassName, function helper, const VALUE};` lower through
  the same class/function/constant alias maps. Class imports apply to
  unqualified names and to the first segment of qualified class names; function
  and constant imports apply to unqualified calls/reads in the current
  supported subset.
- `echo` statements.
