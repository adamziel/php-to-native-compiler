...
| Fixture manifest text audit | `cargo run -p phpc -- test --list-fixtures` | `pass` | Emits sorted fixture metadata, comparison eligibility, and `.phpc-only` marker reason text without running fixtures or proving compatibility. |
