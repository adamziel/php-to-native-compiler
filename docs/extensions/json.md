...
tokens. Focused PHPT proof covers the current JSON core encode/decode rows
...
and the invalid UTF-8 decode row
...
corner cases, exact escaped-string invalid-byte parity, multi-line or
non-ASCII error-location parity, host-extension option catalogs,
