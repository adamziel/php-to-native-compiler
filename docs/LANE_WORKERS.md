...
- Tests/docs lane: Milestone 1115 closes the 1111-1114 implementation-batch
  queue refresh. Milestone 1120 is the next tests/docs slot after the next
  implementation batch.
- Parser lane: Milestone 1116 is the next parser slot, selecting a small
...
- Runtime lane: Milestone 1117 is the next runtime slot, selecting a bounded
  ...
  unsupported edges.
- IR/lowering lane: Milestone 1118 is the next native slot, selecting a narrow
  native IR/lowering refinement or precise rejection boundary from already
  documented interpreter behavior.
- Compiler-output lane: Milestone 1119 is the next compiler-output slot,
...
Milestone 1115 refreshed the next-lane queue.
