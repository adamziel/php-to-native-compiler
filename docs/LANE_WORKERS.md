...
- Tests/docs lane: Milestone 1290 closes the 1286-1289 WordPress-focused
  implementation-batch queue refresh and keeps the next split anchored in the
  `GOAL.MD` compatibility ledger.
- Parser/runtime lane: Milestone 1291 targets a larger object/interface
  blocker, such as trait conflict resolution, visibility-only adaptations,
  inherited method compatibility, constructor/destructor behavior,
  autoloadable class/interface lookup, magic object hooks, or another
  WordPress-reached object construct.
- Runtime lane: Milestone 1292 targets a larger reference/COW blocker, such as
  request-bag or `$GLOBALS` alias mutation, reference-return alias binding,
  object-property or array-offset alias lifetimes beyond the current metadata
  bridges, by-reference iteration, or callback/property shapes reached by
  WordPress.
- Runtime or IR/lowering lane: Milestone 1293 targets request/SAPI,
  filesystem, and stream behavior that blocks real WordPress requests, such as
  cookie/session request state, upload metadata, include-path or stream-wrapper
  behavior, `php://temp`, shutdown-time buffer visibility, or host SAPI import
  scaffolding.
- Compatibility/runtime lane: Milestone 1294 targets executable WordPress
...
- Tests/docs lane: Milestone 1295 is the next tests/docs slot after the next
  WordPress-focused implementation batch.

Milestones 555-560 closed the first split-lane batch, Milestones 561, 571, 587,
592, 597, 602, 607, 612, 617, 1201, 1206, 1211, 1216, 1221, 1226, 1231, 1236, 1241, 1246, 1251, 1256, 1261, 1266, 1271, 1276, 1281, and 1286 closed recent parser slots, Milestones 565, 568,
...
593, 598, 603, 608, 613, 618, 1202, 1207, 1212, 1217, 1222, 1223, 1227, 1228, 1232, 1233, 1237, 1238, 1242, 1243, 1247, 1248, 1252, 1253, 1257, 1258, 1262, 1263, 1267, 1268, 1272, 1273, 1277, 1278, 1282, 1283, 1287, and 1288 closed recent runtime slots, and Milestones 569,
573, 588, 591, 596, 601, 606, 611, 616, 1203, 1208, 1213, and 1218 closed recent IR/lowering slots.
Milestones 1224, 1229, 1234, 1239, 1244, 1249, 1254, 1259, 1264, 1269, 1274, 1279, 1284, and 1289 closed recent WordPress compatibility evidence work. Milestones
604, 609, 614, 619, 1205, 1210, 1215, 1220, 1225, 1230, 1235, 1240, 1245, 1250, 1255, 1260, 1265, 1270, 1275, 1280, 1285, and 1290 closed recent tests/docs
queue refreshes.
