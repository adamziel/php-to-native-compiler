...
- Tests/docs lane: Milestone 1185 closes the 1181-1184 implementation-batch
  queue refresh. Milestone 1190 is the next tests/docs slot after the next
  implementation batch.
- Parser lane: Milestone 1186 is the next parser slot, selecting a small
...
- Runtime lane: Milestone 1187 is the next runtime slot, selecting a bounded
  ...
  unsupported edges.
- IR/lowering lane: Milestone 1188 is the next native slot, selecting a narrow
  native IR/lowering refinement or precise rejection boundary from already
  documented interpreter behavior.
- Compiler-output lane: Milestone 1189 is the next compiler-output slot,
