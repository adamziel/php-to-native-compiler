...
- Tests/docs lane: Milestone 1250 closes the 1246-1249 WordPress-focused
  implementation-batch queue refresh. Milestone 1255 is the next tests/docs
  slot after the next WordPress-focused implementation batch.
- Parser/runtime lane: Milestone 1251 targets the next trait/interface
  WordPress blocker beyond bounded `insteadof` plus public-alias interaction.
- Runtime lane: Milestone 1252 targets the next concrete reference/COW blocker
  reached by WordPress-style public object-property arrays, include scope,
  callbacks, globals, request bags, or mutable `wpdb`/option/cache state.
- Runtime or IR/lowering lane: Milestone 1253 targets request-state,
...
- Compatibility/runtime lane: Milestone 1254 targets executable WordPress
...
592, 597, 602, 607, 612, 617, 1201, 1206, 1211, 1216, 1221, 1226, 1231, 1236, 1241, and 1246 closed recent parser slots, Milestones 565, 568,
...
593, 598, 603, 608, 613, 618, 1202, 1207, 1212, 1217, 1222, 1223, 1227, 1228, 1232, 1233, 1237, 1238, 1242, 1243, 1247, and 1248 closed recent runtime slots, and Milestones 569,
573, 588, 591, 596, 601, 606, 611, 616, 1203, 1208, 1213, and 1218 closed recent IR/lowering slots.
Milestones 1224, 1229, 1234, 1239, 1244, and 1249 closed recent WordPress compatibility evidence work. Milestones
604, 609, 614, 619, 1205, 1210, 1215, 1220, 1225, 1230, 1235, 1240, 1245, and 1250 closed recent tests/docs
queue refreshes.
