...
- Tests/docs lane: Milestone 1265 closes the 1261-1264 WordPress-focused
  implementation-batch queue refresh and anchors the next split in the
  `GOAL.MD` compatibility ledger.
- Parser/runtime lane: Milestone 1266 targets the next large trait/interface
  WordPress blocker, such as interface constants, forward parent-interface
  resolution, or another WordPress-reached trait/interface construct.
- Runtime lane: Milestone 1267 targets the next concrete reference/COW blocker
...
- Runtime or IR/lowering lane: Milestone 1268 targets request-state,
...
- Compatibility/runtime lane: Milestone 1269 targets executable WordPress
...
- Tests/docs lane: Milestone 1270 is the next tests/docs slot after the next
  WordPress-focused implementation batch.

Milestones 555-560 closed the first split-lane batch, Milestones 561, 571, 587,
592, 597, 602, 607, 612, 617, 1201, 1206, 1211, 1216, 1221, 1226, 1231, 1236, 1241, 1246, 1251, 1256, and 1261 closed recent parser slots, Milestones 565, 568,
...
593, 598, 603, 608, 613, 618, 1202, 1207, 1212, 1217, 1222, 1223, 1227, 1228, 1232, 1233, 1237, 1238, 1242, 1243, 1247, 1248, 1252, 1253, 1257, 1258, 1262, and 1263 closed recent runtime slots, and Milestones 569,
573, 588, 591, 596, 601, 606, 611, 616, 1203, 1208, 1213, and 1218 closed recent IR/lowering slots.
Milestones 1224, 1229, 1234, 1239, 1244, 1249, 1254, 1259, and 1264 closed recent WordPress compatibility evidence work. Milestones
604, 609, 614, 619, 1205, 1210, 1215, 1220, 1225, 1230, 1235, 1240, 1245, 1250, 1255, 1260, and 1265 closed recent tests/docs
queue refreshes.
