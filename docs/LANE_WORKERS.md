...
- Tests/docs lane: Milestone 1165 closes the 1161-1164 implementation-batch
  queue refresh. Milestone 1170 is the next tests/docs slot after the next
  implementation batch.
- Parser lane: Milestone 1166 is the next parser slot, selecting a small
...
- Runtime lane: Milestone 1167 is the next runtime slot, selecting a bounded
  ...
  unsupported edges.
- IR/lowering lane: Milestone 1168 is the next native slot, selecting a narrow
  native IR/lowering refinement or precise rejection boundary from already
  documented interpreter behavior.
- Compiler-output lane: Milestone 1169 is the next compiler-output slot,
