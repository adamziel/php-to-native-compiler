...
Measured latest: `ptn-w17z.16` exception/backtrace/lifecycle row pack selected
41 rows, kept 41 runnable, and passed 41/41 in the integrated focused run.
Latest: `ptn-w17z.16` completed the checked-in exception/backtrace/lifecycle
row pack. Previous: `ptn-w17z.15` completed the checked-in iterator/generator
row pack at 36/36.

Current hook: `ptn-w17z.16` exception/backtrace/lifecycle row pack passed
41/41 at
`.runtime/merge-ptn-w17z16-exception-lifecycle/summary-20260615T151015Z.txt`.
Previous hook: `ptn-w17z.15` iterator/generator row pack passed 36/36 at
`.runtime/merge-ptn-w17z15-iterator-generator/summary-20260615T145849Z.txt`.
