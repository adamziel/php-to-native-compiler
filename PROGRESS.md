...
Measured latest: `ptn-w17z.15` iterator/generator row pack selected 36 rows,
kept 36 runnable, and passed 36/36 in the integrated focused run.
Latest: `ptn-w17z.15` completed the checked-in iterator/generator row pack.
Previous: `ptn-w17z.12` completed the checked-in magic methods/lifecycle row
pack at 49/49.

Current hook: `ptn-w17z.15` iterator/generator row pack passed 36/36 at
