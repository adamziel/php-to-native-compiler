...
environment flags). Previous: `ptn-w17z.14` added parse-time `#[Override]`
method/property validation and passed its integrated 34-row checked-in manifest.

Current hook: `ptn-w17z.10` full-corpus 20k SKIPIF candidate row pack moved
134/875 -> 319/875 runnable under harness-program classification; the
