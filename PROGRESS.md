...
Measured latest: `ptn-w17z.16.3` exception formatting row pack selected 13 rows, kept 12 runnable, and passed 12/12 in the focused run.
Latest: `ptn-w17z.16.3` completed the checked-in exception formatting row pack. Previous: `ptn-w17z.33` completed the checked-in extract globals refs row pack at 3/3.

Current hook: `ptn-w17z.16.3` exception formatting row pack passed 12/12 runnable at
`.runtime/merge-ptn-w17z16-3-exception-format/summary-20260615T160318Z.txt`.
Previous hook: `ptn-w17z.33` extract globals refs row pack passed 3/3 at
