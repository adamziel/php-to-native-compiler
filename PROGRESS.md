...
Latest accounted source capability: `4d6f0f1e` adds a shared cleanup-frame
enqueue validation boundary that rejects non-cleanup diagnostic-result surfaces
and terminal-source value ownership before LLVM/generated C cleanup-frame
emission. Previous source commit `8ebeae19` preserves cleanup-frame source
metadata through nested innermost-first stack aggregation before reporting.

Why the headline bars did not jump: the new source hardens cleanup-frame
enqueueing with a reusable ownership blocker, but method/static source calls,
...
For `4d6f0f1e`, `8ebeae19`, `964e3e2b`, `0430efcc`, `75f20f3f`, `d26c64f7`,
