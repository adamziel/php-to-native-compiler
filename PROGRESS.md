...
Measured latest: `ptn-w17z.12` magic methods/lifecycle row pack selected 49
rows and passed 49/49 after all 49 failed on saved base `5a4d735dfd5d`.
Latest: `ptn-w17z.12` completed the checked-in magic methods/lifecycle row
pack. Previous: `ptn-w17z.10` expanded modeled static SKIPIF preconditions and
moved 134 -> 319 runnable rows under harness-program classification.

Current hook: `ptn-w17z.12` magic methods/lifecycle row pack passed 49/49 at
`.runtime/merge-ptn-w17z12-magic-lifecycle/summary-20260615T144358Z.txt`.
Previous hook: `ptn-w17z.10` full-corpus 20k SKIPIF candidate row pack kept
185/185 rows runnable at
