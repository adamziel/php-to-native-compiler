...
Measured latest: `ptn-w17z.22` compile-time include path variable acceptance
selected 1 row, kept 1 runnable, and passed 1/1 in the focused run.
Latest: `ptn-w17z.22` supports `__DIR__` assigned to a simple variable and
...
Current hook: `ptn-w17z.22` compile-time include path variable acceptance
passed 1/1 at
