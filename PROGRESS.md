...
Latest accounted source capability: `28ce0faa` routes selected generated-C
nested ArrayAccess pre/post increment and decrement through the generalized
nested owner-stack write context for direct-variable and property-held roots.
...
distinct. Top-level `static::$prop`, object static-property receivers, dynamic
class/property names, static-property references, compound
...
- Nested ArrayAccess `??=`/append/unset/reference-returning production,
  ...
  boundary.
- LLVM static-property producers, generated-C dynamic/object-static
  static-property shapes, dynamic/magic/typed-static property lowering, and
