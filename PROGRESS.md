...
Measured latest: `ptn-w17z.10` full-corpus 20k SKIPIF candidate row pack
selected 875 rows from the generated 20k manifest and moved 134 -> 319
runnable under `--classify-harness-programs` (+185).
Latest: `ptn-w17z.10` expanded modeled static SKIPIF preconditions for common
host/environment gates (`PHP_INT_MAX`, OS family/prefix, debug/ZTS, and generic
environment flags). Previous: `ptn-w17z.20` added generic stream/path runtime
coverage and moved its full-corpus 20k-family stream/path manifest from 0/35
runnable to 35/35 passing. Earlier: `ptn-w17z.7` added ReflectionClass runtime
metadata coverage for class names, parent/interface relationships, modifiers,
methods, properties, constants, instantiability, and object print_r formatting.

Current hook: `ptn-w17z.10` full-corpus 20k SKIPIF candidate row pack moved
134/875 -> 319/875 runnable under harness-program classification.
