...
public-progress watch targets are p15 `returnByReference.005`, p16
`call_static` / magic map, p17 `assign_obj_ref_return`, p18
`assign_typed_ref_result`, p19 `passByReference_005`, p7 queue, p14
critic heartbeat, and any new full-suite PHPT row. Extra sessions
