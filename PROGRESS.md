...
Previous: `ptn-w17z.25` completed the checked-in serialize/unserialize
reference identity row pack at 6/6.

Current hook: `ptn-w17z.33` extract globals refs row pack passed 3/3 at
`.runtime/merge-ptn-w17z33-extract-globals-refs/summary-20260615T155503Z.txt`.
Previous hook: `ptn-w17z.25` serialize/unserialize reference identity row pack
passed 6/6 at
