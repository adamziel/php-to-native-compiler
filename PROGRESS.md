...
Measured latest: `ptn-w17z.35` compact closure this row pack selected 2 rows, kept 2 runnable, and passed 2/2 in the focused run.
Latest: `ptn-w17z.35` completed the checked-in compact closure this row pack. Previous: `ptn-w17z.16.3` completed the checked-in exception formatting row pack at 12/12 runnable.
...
Previous hook: `ptn-w17z.16.3` exception formatting row pack passed 12/12 runnable at
