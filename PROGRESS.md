...
`6caaa387 native: add callable identity return summaries`.

`6caaa387` adds a generated-C callable identity and return-summary boundary.
Generated functions, declared instance methods, and declared static methods now
resolve through shared callable identities before publishing native value facts;
the summary resolver rejects arity-incompatible callables and reference-returning
callables instead of treating every method/function path as a local fact query.
Focused proof covers direct generated functions, instance methods, static
methods, and the existing native-link ArrayAccess producer fact consumers.
...
callable return producer facts, `2ee642ff` ReferenceSlot owner facts,
cleanup/unwind requirement preflight, selected generated-C RMW array-lvalue
owner/writeback, runtime ArrayAccess read/write dispatch ABIs, and generated
declared-method callable-table publication.

Lane-local momentum is active but not counted. Property/reference owner,
closure body-summary, and owner-scoped fact candidates exist from previous heads
and must be fresh-head audited before any integration. Broader producer fact
work, property/nested owner design, dynamic callable consumers, and callable
...
| Callable identity return summaries | **100%** `[####################]` | **100%** `[####################]` | **55%** `[###########---------]` | Integrated at `6caaa387` for generated functions, declared instance methods, and declared static methods through shared callable identities and return summaries. Dynamic runtime callables, descriptor closures, recursive/fixed-point summaries, reference returns, property/magic producers, references/COW, and backend parity remain open. |
| Callable return producer facts | **100%** `[####################]` | **100%** `[####################]` | **55%** `[###########---------]` | Integrated through `6caaa387` for generated function/method/static-method return summaries feeding existing object/interface fact consumers through the shared callable identity resolver. Recursive/fixed-point summaries, dynamic runtime callables, descriptor closures, property/magic producers, references/COW, and backend parity remain open. |
| Dynamic object/interface fact carrier | **100%** `[####################]` | **100%** `[####################]` | **62%** `[############--------]` | Integrated through `6caaa387` for generated-C native value/object facts over generated declared objects, known dynamic class-name `new`, copies, gotos, branch joins, generated-callable identity return summaries, and compiler-visible reference slots, consumed by ArrayAccess read/isset/write/append/unset/empty/null-coalesce/RMW/`??=`. Producers from properties, clones, static properties, arbitrary symbols, dynamic runtime callables, and descriptor closures remain open. |
...
- [x] Shared callable identity and return-summary resolver for generated
  functions, declared instance methods, and declared static methods.
...
- [ ] Broader object/interface fact carriers for producers beyond generated
  ...
  returns.
- [ ] Property-held/nested ArrayAccess owner, dynamic callable, descriptor
  closure, and callable-return producer fact expansion.
