...
Refresh: 2026-06-10T14:15Z
Measured: `ptn-m6m` rebased on `origin/master@51e3314`; anonymous callback
closures, static callables, string-callable callbacks, recursive directory
APIs, bounded `stdClass` property evidence, and focused string-internal
TypeError evidence.
...
property reads/writes shared through object aliases, and catchable
first-argument array/object TypeErrors for `md5()`, `quotemeta()`,
`strip_tags()`, `quoted_printable_decode()`, and `soundex()`.
...
array/string internals including remaining string operand diagnostics, 64-bit
