...
`typed_properties_026`/successors, variadic `bug80049`/successors, magic
`bug66609`/successors, foreach `bug67633`/successors, list-keyed
successors, the next p7-reviewed candidate plus p14 `SAFE-FOR-PROGRESS`
audit, current coder lane artifacts, and any new full-suite PHPT row. Known no-go/not-safe items,
