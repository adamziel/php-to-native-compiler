...
Measured latest: `ptn-w17z.18` numeric/math/conversions row pack moved 0/35
to 35/35 runnable rows passing.
Latest: `ptn-w17z.18` added generic numeric/math conversion internals for
base conversion and unary/binary math wrappers; the integrated focused run
selected 35 rows and passed 35/35. Previous: `ptn-kia6` improved generic
by-reference return, argument, assignment, `$GLOBALS`, `$this`, and nested
