...
Measured latest: `ptn-w17z.7` ReflectionClass metadata row pack selected
36 full-corpus reflection rows and passed 36.
Latest: `ptn-w17z.7` added ReflectionClass runtime metadata coverage for
class names, parent/interface relationships, modifiers, methods, properties,
constants, instantiability, and object print_r formatting. Previous:
...
Current hook: `ptn-w17z.7` ReflectionClass metadata row pack selected 36
full-corpus reflection rows and passed 36/36.
