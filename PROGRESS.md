...
cleanup row pack passed 4/4 checked-in rows. Previous: `ptn-w17z.21` added
scalar date/time runtime coverage and PHP-shaped numeric formatting edges,
with date scalar 0/40 -> 29/40 and formatting 29/52 -> 41/52. Earlier:
`ptn-w17z.3` array sort flags moved 17/76 -> 63/76, and `ptn-w17z.11`
namespace/include rows passed 26/26.
