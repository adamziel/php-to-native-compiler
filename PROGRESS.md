...
public-progress watch targets are p7 `passByReference_008` /
`passByReference_009` PASS-NO-PATCH review, p19 `passByReference_005`
rebase/new SHA, current coder lane artifacts, p14 critic heartbeat, and any
new full-suite PHPT row. Extra sessions
