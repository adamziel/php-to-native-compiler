...
Latest accounted source capability: `1202542e` routes selected generated-C
...
`static::$prop`, static-property references, `??=`, `unset`, `isset`, `empty`,
...
original owner, and preserve the `??=` expression result. Append-with-keyed
suffix, nested unset, reference-returning `offsetGet()`, arbitrary alias roots,
