...
| Final focused source bucket | `.runtime/ptn-w17z14-override-properties-after/summary-20260615T130108Z.txt`: 50 selected, 47 runnable, 3 classified; 47 passed, 0 failed |
| Checked-in row-pack run | `.runtime/ptn-w17z14-row-pack-after/summary-20260615T130409Z.txt`: 34 selected, 34 runnable, 34 passed, 0 failed |
...
| `cargo test override_attributes --test compile_native -- --nocapture` | passed 2/2 |
| `cargo test parser_ignores_override_identifier_inside_non_override_attribute_arguments --test compile_native -- --nocapture` | passed 1/1 |
| `cargo test phpt_classifier_splits_attribute_metadata_blockers --test phpt_classifier -- --nocapture` | passed 1/1 |
| `tools/run-bounded-phpt.sh --classify-harness-programs tools/phpt-ptn-w17z14-override-attribute-row-pack.txt` | passed 34/34 |
