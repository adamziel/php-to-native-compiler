...
Latest accounted source capability: `5a4f10a5` routes compiler-known
generated-C dynamic receiver-method calls with known string method names through
the shared source-call carrier stack, including class-context access for
...
unsupported receiver shapes blocked. Recent source commits also route selected
