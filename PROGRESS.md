...
pack selected 6 rows, kept 6 runnable, and passed 6/6 in the integrated
focused run.
Latest: `ptn-w17z.25` completed the checked-in serialize/unserialize reference
identity row pack. Previous: `ptn-w17z.16` completed the checked-in
exception/backtrace/lifecycle row pack at 41/41.

Current hook: `ptn-w17z.25` serialize/unserialize reference identity row pack
passed 6/6 at
`.runtime/merge-ptn-w17z25-serialize-reference-identity/summary-20260615T154738Z.txt`.
