...
#define PTN_BUILTIN_INT_CONSTANT(constant_name, value) \
    ...
    PTN_BUILTIN_INT_CONSTANT("PHP_ROUND_HALF_UP", 1)
    PTN_BUILTIN_INT_CONSTANT("PHP_ROUND_HALF_DOWN", 2)
    PTN_BUILTIN_INT_CONSTANT("PHP_ROUND_HALF_EVEN", 3)
    PTN_BUILTIN_INT_CONSTANT("PHP_ROUND_HALF_ODD", 4)
