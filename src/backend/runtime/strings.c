...
#define PTN_BUILTIN_INT_CONSTANT(constant_name, value) \
    ...
    PTN_BUILTIN_INT_CONSTANT("OPENSSL_VERSION_NUMBER", 0x30000000)
    PTN_BUILTIN_INT_CONSTANT("OPENSSL_RAW_DATA", 1)
    PTN_BUILTIN_INT_CONSTANT("OPENSSL_ZERO_PADDING", 2)
    PTN_BUILTIN_INT_CONSTANT("OPENSSL_PKCS1_PADDING", 1)
    PTN_BUILTIN_INT_CONSTANT("OPENSSL_SSLV23_PADDING", 2)
    PTN_BUILTIN_INT_CONSTANT("OPENSSL_NO_PADDING", 3)
    PTN_BUILTIN_INT_CONSTANT("OPENSSL_PKCS1_OAEP_PADDING", 4)
    PTN_BUILTIN_INT_CONSTANT("OPENSSL_ALGO_SHA1", 1)
    PTN_BUILTIN_INT_CONSTANT("OPENSSL_ALGO_SHA224", 6)
    PTN_BUILTIN_INT_CONSTANT("OPENSSL_ALGO_SHA256", 7)
    PTN_BUILTIN_INT_CONSTANT("OPENSSL_ALGO_SHA384", 8)
    PTN_BUILTIN_INT_CONSTANT("OPENSSL_ALGO_SHA512", 9)
