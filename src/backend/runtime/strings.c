...
#define PTN_BUILTIN_INT_CONSTANT(constant_name, value) \
    ...
    PTN_BUILTIN_INT_CONSTANT("CURLOPT_SAFE_UPLOAD", -1)
    PTN_BUILTIN_INT_CONSTANT("CURLOPT_STDERR", 10037)
    PTN_BUILTIN_INT_CONSTANT("CURLOPT_VERBOSE", 41)
    PTN_BUILTIN_INT_CONSTANT("CURLOPT_NOPROGRESS", 43)
    PTN_BUILTIN_INT_CONSTANT("CURLOPT_XFERINFOFUNCTION", 20219)
    PTN_BUILTIN_INT_CONSTANT("CURLOPT_PROGRESSFUNCTION", 20056)
    PTN_BUILTIN_INT_CONSTANT("CURLOPT_WILDCARDMATCH", 197)
    ...
    PTN_BUILTIN_INT_CONSTANT("CURLM_BAD_HANDLE", 1)
    ...
    PTN_BUILTIN_INT_CONSTANT("U_ILLEGAL_ARGUMENT_ERROR", 1)
    PTN_BUILTIN_INT_CONSTANT("U_INVALID_CHAR_FOUND", 10)
    PTN_BUILTIN_INT_CONSTANT("ULOC_ACTUAL_LOCALE", 0)
    PTN_BUILTIN_INT_CONSTANT("ULOC_VALID_LOCALE", 1)
    ...
    PTN_BUILTIN_INT_CONSTANT("TOKEN_PARSE", PTN_TOKEN_PARSE)
    ...
    PTN_BUILTIN_INT_CONSTANT("T_NULLSAFE_OBJECT_OPERATOR", PTN_T_NULLSAFE_OBJECT_OPERATOR)
    PTN_BUILTIN_INT_CONSTANT("T_BAD_CHARACTER", PTN_T_BAD_CHARACTER)
    ...
    PTN_BUILTIN_INT_CONSTANT("T_AMPERSAND_FOLLOWED_BY_VAR_OR_VARARG", PTN_T_AMPERSAND_FOLLOWED_BY_VAR_OR_VARARG)
    PTN_BUILTIN_INT_CONSTANT("T_AMPERSAND_NOT_FOLLOWED_BY_VAR_OR_VARARG", PTN_T_AMPERSAND_NOT_FOLLOWED_BY_VAR_OR_VARARG)
