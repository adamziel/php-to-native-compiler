...
#define PTN_BUILTIN_INT_CONSTANT(constant_name, value) \
    ...
    PTN_BUILTIN_INT_CONSTANT("STREAM_CLIENT_PERSISTENT", PTN_STREAM_CLIENT_PERSISTENT)
    PTN_BUILTIN_INT_CONSTANT("STREAM_CLIENT_ASYNC_CONNECT", PTN_STREAM_CLIENT_ASYNC_CONNECT)
    PTN_BUILTIN_INT_CONSTANT("STREAM_CLIENT_CONNECT", PTN_STREAM_CLIENT_CONNECT)
