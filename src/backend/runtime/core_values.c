...
#define PTN_ZLIB_ERRNO -1
#define PTN_ZLIB_STREAM_ERROR -2
#define PTN_ZLIB_DATA_ERROR -3
#define PTN_ZLIB_MEM_ERROR -4
#define PTN_ZLIB_BUF_ERROR -5
#define PTN_ZLIB_VERSION_ERROR -6
