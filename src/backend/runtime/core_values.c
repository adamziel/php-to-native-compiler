...
#define PTN_STREAM_OPTION_BLOCKING 1
#define PTN_STREAM_OPTION_READ_BUFFER 2
#define PTN_STREAM_OPTION_WRITE_BUFFER 3
#define PTN_STREAM_OPTION_READ_TIMEOUT 4
#define PTN_STREAM_BUFFER_NONE 0
#define PTN_STREAM_BUFFER_LINE 1
#define PTN_STREAM_BUFFER_FULL 2
#define PTN_STREAM_IS_URL 1
#define PTN_STREAM_URL_STAT_LINK 1
#define PTN_STREAM_URL_STAT_QUIET 2
#define PTN_STREAM_MKDIR_RECURSIVE 1
...
#define PTN_ZIP_EM_NONE 0
#define PTN_ZIP_EM_TRAD_PKWARE 1
#define PTN_ZIP_EM_AES_128 257
#define PTN_ZIP_EM_AES_192 258
#define PTN_ZIP_EM_AES_256 259
...
struct PtnRuntime {
    ...
    int suppress_by_ref_argument_warning_frame_location;
...
static PTN_UNUSED void ptn_generator_throw_aborted_yield_from_error(PtnRuntime *runtime, size_t line);
...
static PTN_UNUSED int ptn_internal_class_name_is_parent_iterator(const char *class_name);
...
static PTN_UNUSED PtnValue ptn_parent_iterator_new(
    PtnRuntime *runtime,
    size_t argc,
    const PtnValue *args,
    size_t line
...
static PTN_UNUSED PtnValue ptn_parent_iterator_call_method(
    PtnRuntime *runtime,
    PtnValue receiver,
    const char *name,
    size_t argc,
...
static PTN_UNUSED void ptn_internal_prepare_foreach_iterator(
    PtnRuntime *runtime,
    PtnValue iterator,
    size_t line
);
