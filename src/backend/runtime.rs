...
pub(super) const STRING_ARG_HELPERS_START: &str = "/* PTN_STRING_ARG_HELPERS_START */";
pub(super) const STRING_ARG_HELPERS_END: &str = "/* PTN_STRING_ARG_HELPERS_END */";
pub(super) const SPRINTF_HELPERS_START: &str = "/* PTN_SPRINTF_HELPERS_START */";
pub(super) const SPRINTF_HELPERS_END: &str = "/* PTN_SPRINTF_HELPERS_END */";
