...
pub(super) const NAMED_CALL_HELPERS_START: &str = "/* PTN_NAMED_CALL_HELPERS_START */";
pub(super) const NAMED_CALL_HELPERS_END: &str = "/* PTN_NAMED_CALL_HELPERS_END */";
pub(super) const PCRE_INTERNAL_HELPERS_START: &str = "/* PTN_PCRE_INTERNAL_HELPERS_START */";
pub(super) const PCRE_INTERNAL_HELPERS_END: &str = "/* PTN_PCRE_INTERNAL_HELPERS_END */";
pub(super) const URI_INTERNAL_HELPERS_START: &str = "/* PTN_URI_INTERNAL_HELPERS_START */";
pub(super) const URI_INTERNAL_HELPERS_END: &str = "/* PTN_URI_INTERNAL_HELPERS_END */";
pub(super) const JSON_INTERNAL_HELPERS_START: &str = "/* PTN_JSON_INTERNAL_HELPERS_START */";
pub(super) const JSON_INTERNAL_HELPERS_END: &str = "/* PTN_JSON_INTERNAL_HELPERS_END */";
