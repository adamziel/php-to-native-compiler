...
| Symbols/request/globals | 53% | In progress | Extend beyond direct keyed request storage into nested/path request reads/writes/unsets, `$GLOBALS` aliasing, request-root reference consumers, assignment-expression values, or request lifetime threading. |
