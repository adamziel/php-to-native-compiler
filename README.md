...
- null coalescing assignment `$name ??= expr` for direct static variables over
...
- stable lex/parse diagnostics for unsupported dynamic/function features
  ...
  conditional expressions, unsupported chained coalescing and non-variable
  null coalescing assignment forms, object
