...
- builtins for the documented scalar/array/object subset: `strlen`, `isset`,
  ...
  preservation, `array_diff($left, $right)` over scalar values with
  first-array key/value preservation, variadic `array_intersect` over two or
  more arrays with scalar value comparisons and first-array key/value
  preservation,
