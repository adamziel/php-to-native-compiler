...
- `docs/PHPT_BROAD_1K_ZEND_ROOT_CURRENT_FRONTIER_2026-06-14.md`: current
  broad 1k root-level Zend runnable frontier, focused manifest, and residual
  runtime/control/object blocker map.
