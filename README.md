...
properties, object handle identity, clone expressions, property default values,
constructor arguments, multiple properties in one declaration, class constant
declarations, static property storage, static method dispatch, class constants,
enum declarations, and native object lowering are not supported yet.
