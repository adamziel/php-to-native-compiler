...
- `str_replace()` supports scalar and ordered-array byte replacement, writes
  the optional `$count` argument by reference, maps subject arrays with
  preserved keys, and throws PHP-style TypeErrors for invalid top-level
  resource/object operands.
