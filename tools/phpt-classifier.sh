...
PTN_PHPT_SUPPORTED_EXTENSIONS_DEFAULT="bcmath,calendar,Core,ctype,curl,date,dom,filter,hash,iconv,intl,json,libxml,mbstring,mysqli,odbc,openssl,pcre,pdo,pdo_dblib,pdo_firebird,pdo_mysql,pdo_odbc,pdo_pgsql,pdo_sqlite,pgsql,Phar,phar,Reflection,sockets,soap,SPL,sqlite3,standard,tokenizer,uri,xml,xmlreader,xmlwriter,zip,zlib"
