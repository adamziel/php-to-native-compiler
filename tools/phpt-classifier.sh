...
ptn_phpt_unsupported_ini_blocker() {
    ...
    case "$key" in
        ...
        opcache.opt_debug_level)
            printf 'unsupported-opcache-observability\trequires Zend OPcache opcode optimizer dump output; PTN models opcache API/INI state without optimizer disassembly\n'
            return 0
            ;;
        sys_temp_dir)
