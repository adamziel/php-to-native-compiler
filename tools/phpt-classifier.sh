...
PTN_PHPT_SUPPORTED_EXTENSIONS_DEFAULT="Core,ctype,curl,date,filter,hash,iconv,intl,json,mbstring,openssl,pcre,Phar,phar,Reflection,sockets,soap,SPL,standard,tokenizer,zip,zlib"
